...
from .llm_client import LLM_TEXT_MODEL, LLM_VISION_MODEL
...
class VisualHealer:
            ...
            messages=[
                {
                    ...
                    "content": [
                        ...
                        {"type": "image_url", "image_url": {"url": image_as_base64}},
                    ],
                }
            ],
            temperature=0.1,
    ...
    def get_error_explanation(self, data, result, image_as_base64):
        schema = {
            "keyword": {"type": "string", "description": "The Keyword Name"},
            "args": {
                "type": "array",
        ...
        messages.append({"role": "assistant", "content": f"Analysis: {analysis}"})
    ...
    def is_application_still_loading(self, data, result, image_as_base64):
        ...
        messages.append({"role": "user", "content": "", "images": [image_as_base64]})
